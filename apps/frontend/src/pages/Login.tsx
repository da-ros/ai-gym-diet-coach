...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[hsl(0,0%,98%)] relative overflow-hidden">
      <div className="absolute top-0 right-0 w-72 h-72 rounded-full bg-primary/[0.06] blur-[80px]" />
      <div className="absolute bottom-1/3 left-0 w-56 h-56 rounded-full bg-primary/[0.04] blur-[60px]" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm mb-8">Sign in to FuelCoach</p>
          ...
          <form onSubmit={handleLogin} className="w-full space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 rounded-xl bg-primary text-primary-foreground font-semibold text-base shadow-sm hover:bg-primary/90 transition-all"
            >
              {loading ? (
                <motion.div
